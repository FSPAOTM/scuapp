...
class TboutWork(models.Model):
    ...
    w_ps_1 = models.CharField(db_column='W_Ps_1', max_length=200, blank=True, null=True)#区域
    w_ps_2 = models.CharField(db_column='W_Ps_2', max_length=200, blank=True, null=True)# 详细地址
